...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link href="/kegiatan1/bootstrap/bootstrap-5.0.0-beta3-dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+0RDqr0Ql0h+rP48ckxlpbzKgwra6" crossorigin="anonymous">
    ...
    <body>
        <h1 class="p-4"></h1>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-info shadow-lg p-2">
            <div class="container">
                <h3>website ku  | </h3>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/kegiatan1/public">Home</a>
                        </li>                        
                    </ul>
                </div>
            </div>
        ...
        <section class="jumbatron text-center">
            <div class="row justify-content-center" id="signin">
                <div class="container1 text-center">
                    <h2 class="display-4">Framework</h2>
                </div>
            </div>
        </section>
        <div class="container">
            <h2 class="lead">1. Pengertian Framework</h2>
            ...
            <h2 class="lead">2. Fungsi Framework</h2>
            ...
            <div class="container">
                <h3 class="lead">a. Kode program lebih terstruktur</h3>
                <p>Fungsi framework yang utama adalah membuat source code menjadi lebih terstruktur. Terstruktur disini, berarti program yang dibuat akan dimasukkan ke dalam setiap komponen sesuai dengan fungsi nya masing – masing.
                ...
                <h3 class="lead">b. Membantu kinerja dari developer</h3>
                <p>Fungsi yang kedua adalah membantu kinerja dari developer sendiri. Dari sini, anda pasti sudah berpikir bahwa sebenarnya dalam membuat sebuah aplikasi dapat dilakukan tanpa menggunakan bantuan framework. Tentu saja, bisa dilakukan jika proyek yang ditangani dalam lingkup kecil.
                ...
                <h3 class="lead">c. Meningkatkan keamanan perangkat lunak / website</h3>
                ...
                <h3 class="lead">d. Pemeliharaan dan dokumentasi dari website lebih mudah</h3>
                <p>Apabila anda ingin menambahkan atau mengurangi beberapa fitur dari website yang anda buat, maka dengan menggunakan framework dapat memudahkan anda untuk melakukan hal tersebut. Mengapa? Kami beri contoh framework Laravel sendiri memiliki fitur untuk melakukan maintenance pada program.
                ...
                <h3 class="lead">e. Mempercepat dalam proses pembuatan website</h3>
                <p>Fungsi terakhir adalah untuk mempercepat dalam proses pembuatan website. Dalam hal ini, bukan berarti pembuatan website yang baik dikerjakan dengan cepat saja. Tetapi, proses pembuatan dapat dilakukan dengan lebih cepat dan menghasilkan produk yang berkualitas dan sesuai dengan kebutuhan customer.
        ...
        <footer class="bg-info text-white text-center p-3">
            <p>Created By <a class="text-white fw-bold">Teddy Sawon Setyo</a></p> 
        </footer>

        <script src="/kegiatan1/bootstrap/bootstrap-5.0.0-beta3-dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
    </body>
</html>